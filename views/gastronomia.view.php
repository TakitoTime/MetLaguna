...
<head>
    ...
    <link rel="stylesheet" href="css/gastronomia.css" crossorigin="anonymous">
...
<body>
    ...
    <section class="contenedor">
        ...
        <div class="banner">
            <h1>Comida Tipica De La Region Lagunera</h1>
        </div>
                ...
                <div class="lugaresContainer">
                    <div class="card lugarCard">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                            <img src="img/gorditas.jpg" class="card-img imageCard" alt="...">
                            </div>
                            <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="gastronomia">
                ...
                <div class="gastronomiaContainer">
                    <div class="card platilloCard">
                        <div class="row no-gutters">
                            <div class="col-md-4">
                            <img src="img/arocena.jpg" class="card-img imageCardPlatillo" alt="...">
                            </div>
                            <div class="col-md-8">
